...
if True:
    array = np.array([1, 4, 5, 8], float) #element is defined as float
    print array
    print ""
...
if True:
    ...
    print array[1]
    print ""
    print array[:2] #[0,2), so only 0,1 two elements
    print ""
    array[1] = 5.0 #update value at specified pos
    print array[1]
...
if True:
    ...
    print two_D_array
    print ""
    print two_D_array[1][1] #the 2nd element of 2nd row
    print ""
    print two_D_array[1, :] #the 2nd row, 1d array!!
    print two_D_array[1:, :] #the 2nd row, 2d array
    print ""
    #!shown as 1d array
    print two_D_array[:, 2] 
    #!shown as 2d array
